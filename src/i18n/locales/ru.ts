...
const ru: Translation = {
    ...
    streams: {
        ...
        sourcePickerLabel: 'Выберите источник',
        loadingSources: 'Загрузка источников…',
        noSources: 'Источники не найдены',
        sourceLoadFailed: 'Не удалось загрузить доступные экраны и окна.',
        refreshSources: 'Обновить источники',
        selectedSource: 'Выбрано: {{name}}',
        chooseSource: 'Выбрать источник',
        sourcePickerTitle: 'Выберите, что показывать',
        audioLabel: 'Звук',
        shareAudio: 'Передавать звук',
        audioNone: 'Без звука',
        audioNoneDescription: 'Только видео без звука.',
        audioDesktop: 'Звук рабочего стола',
        audioDesktopDescription: 'Передавать системный звук, если платформа это поддерживает.',
        audioApplication: 'Звук приложения',
        audioApplicationDescription: 'В Windows передается только выбранное приложение. На других платформах используется системный звук, если он доступен.',
