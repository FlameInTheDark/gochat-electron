...
const en: Translation = {
    ...
    streams: {
        ...
        sourcePickerLabel: 'Select source',
        loadingSources: 'Loading sources…',
        noSources: 'No sources found',
        sourceLoadFailed: 'Could not load available screens and windows.',
        refreshSources: 'Refresh sources',
        selectedSource: 'Selected: {{name}}',
        chooseSource: 'Choose Source',
        sourcePickerTitle: 'Choose what to share',
        audioLabel: 'Audio',
        shareAudio: 'Share audio',
        audioNone: 'No audio',
        audioNoneDescription: 'Stream video only.',
        audioDesktop: 'Desktop audio',
        audioDesktopDescription: 'Include system audio when the platform supports it.',
        audioApplication: 'Application audio',
        audioApplicationDescription: 'On Windows, include only the selected app. Other desktop platforms fall back to system audio when available.',
